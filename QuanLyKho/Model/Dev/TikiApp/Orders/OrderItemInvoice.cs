...
namespace QuanLyKho.Model.Dev.TikiApp.Orders
{
    ...
    public class OrderItemInvoice
    {
        ...
        public Double discount_tikier { get; set; }

        public Double discount_tiki_first { get; set; }

        public Object discount_data { get; set; }
        ...
        /// Fee details
        /// </summary>
        public List<OrderItemFee> fees { get; set; }
    }
}
