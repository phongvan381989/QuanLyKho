...
{
    public class ViewModelOrderCheckProductInWarehouseViewBindingTiki : ViewModelBase
    {
        public static int indexCheck = -1;
        public ViewModelOrderCheckProductInWarehouseViewBindingTiki(ModelMappingSanPhamTMDT_SanPhamKho e, int quantity, int inputIndex)
        {
            isChecked = false;
            code = e.code;
            name = e.name;
